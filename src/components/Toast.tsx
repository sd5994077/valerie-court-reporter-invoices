    ...
    <>
      {show && (
        <div className={`fixed bottom-4 left-4 z-50 transform transition-all duration-500 ease-out ${
          ...
          <div className="bg-gradient-to-r from-purple-600 to-purple-700 text-white px-6 py-4 rounded-lg shadow-2xl max-w-md border-l-4 border-purple-300 hover:shadow-3xl hover:scale-[1.02] transition-all duration-200">
            <div className="flex items-start justify-between">
              ...
              <button
                onClick={onClose}
                className="flex-shrink-0 ml-4 p-1 text-purple-200 hover:text-white hover:bg-purple-800 rounded-full transition-all duration-200 hover:scale-110 active:scale-95 focus:outline-none focus:ring-2 focus:ring-purple-300"
