    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto animate-in slide-in-from-bottom-8 duration-1000 delay-300">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 ease-out group">
            <div className="bg-purple-600 px-4 sm:px-6 py-4 group-hover:bg-purple-700 transition-colors duration-300">
              ...
              <p className="text-purple-100 mt-1 text-sm sm:text-base">Generate professional invoices for your {branding.business.type.toLowerCase()}</p>
            </div>
            <div className="p-4 sm:p-6">
              ...
              <div className="flex justify-center">
                <Link href="/create-invoice">
                  <button className="bg-gradient-to-r from-purple-500 to-purple-700 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold hover:from-purple-600 hover:to-purple-800 transition-all duration-200 flex items-center justify-center space-x-2 text-sm sm:text-base shadow-lg hover:shadow-xl transform hover:scale-105">
        ...
        <div className="mt-12 sm:mt-16">
          <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 lg:p-8 max-w-3xl mx-auto border-l-4 border-purple-500">
            ...
            <div className="flex flex-wrap justify-center gap-2 sm:gap-4 text-xs sm:text-sm text-purple-600 font-medium">
              <span className="bg-purple-50 px-2 sm:px-3 py-1 rounded-full">Template System</span>
              <span className="bg-purple-50 px-2 sm:px-3 py-1 rounded-full">Customizable</span>
              <span className="bg-purple-50 px-2 sm:px-3 py-1 rounded-full">Professional</span>
              <span className="bg-purple-50 px-2 sm:px-3 py-1 rounded-full">Easy Setup</span>
            </div>
          </div>
        </div>
